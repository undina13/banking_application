...
public class ScoringDataDTOData {
    ...
    public static ScoringDataDTO scoringDataDTO1 = new ScoringDataDTO(BigDecimal.valueOf(10000),
            6,"Sidor","Sidorov","Petrovich", Gender.MALE,
            LocalDate.parse("2005-08-09", formatter), "9999", "623456",
            LocalDate.parse("2022-07-13", formatter), "556-876", MaritalStatus.MARRIED, 2,
            employmentDTO, "account", false, false);
}
