...
public class ConveyorController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Ошибка валидации",
                    content = @Content)})
    @PostMapping("/offers")
    public ResponseEntity<List<LoanOfferDTO>> getLoanOffers(@RequestBody @Parameter(required = true) LoanApplicationRequestDTO loanApplicationRequestDTO) {
    ...
    public ResponseEntity<CreditDTO> getCalculation(@RequestBody @Parameter(required = true) ScoringDataDTO scoringDataDTO) {
